Create one horizontal animation strip for Codex pet `chordling`, state `running-right`.
...
Identity: same pet in every frame: A compact friendly mascot inspired by guitar chords and creative coding: small whole-body pet with a warm face, a tiny guitar-pick charm, subtle fretboard-pattern accents, nimble hands, curious focused expression, readable silhouette at pet size, no text or logos.. Preserve silhouette, face, proportions, markings, palette, material, style, and props.
Style: Pet-safe sprite: compact full-body mascot, readable in a 192x208 cell, clear silhouette, simple face, stable palette/materials, and crisp edges for chroma-key extraction. Style `3d-toy`: Stylized 3D toy mascot with smooth rounded forms, simple materials, clear silhouette, and no photoreal complexity. User style notes: soft matte 3D toy mascot, warm but not beige-dominant palette, teal and coral accents, clean crisp edges, pet-sized readability.
